...
export const isQueued = (w: { queue?: WorkflowQueue | null } | null | undefined): boolean =>
  w?.queue?.state === 'queued' && (w.queue.position ?? 0) > 0;

/** "Next in line" / "3rd in line" / "50+ in line" */
export function queuePositionLabel(queue: WorkflowQueue | null | undefined): string | null {
...
export function queueSummary(queue: WorkflowQueue | null | undefined): string | null {
