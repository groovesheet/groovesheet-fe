...
export declare enum AlignRestOption {
    Never = 0,// false should also work
    Always = 1,// true should also work
    Auto = 2
}
export declare enum FillEmptyMeasuresWithWholeRests {
    No = 0,
    YesVisible = 1,
    YesInvisible = 2
}
...
export declare enum SkyBottomLineBatchCalculatorBackendType {
    Plain = 0,
    WebGL = 1
}
/** Handles [[IOSMDOptions]], e.g. returning default options with OSMDOptionsStandard() */
export declare class OSMDOptions {
