...
export declare class GraphicalMusicSheet {
    ...
    GetNearestVoiceEntry(clickPosition: PointF2D, ignoreGraceNotes?: boolean): GraphicalVoiceEntry;
    ...
    calculateXPositionFromTimestamp(timeStamp: Fraction, stayAtLeftStaffEntry?: boolean): [number, MusicSystem, GraphicalStaffEntry];
