...
export declare class EngravingRules {
    ...
    /** Whether to prevent playing measures that are not rendered (e.g. smaller than MinMeasureToDrawNumber).
     * Default true. This helps set playback to the right start position when you set MinMeasureToDrawNumber > 1.
     * If you want to play the score without rendering, you might want to set this to false.
     */
    NeverPlayUnrenderedMeasures: boolean;
    ...
    /** Whether to interpolate the cursor position for longer notes,
     * e.g. for a half note, after a beat, the cursor x-position will be at half point to the next note position. */
    InterpolateCursorPositionBetweenNotesDuringPlayback: boolean;
