...
function FilterGroup({ title, items, value, onToggle, defaultOpen = true }: FilterGroupProps) {
  const [open, setOpen] = useState(defaultOpen);

  return (
    <div className="filter-group">
      <button type="button" className="fg-header" onClick={() => setOpen((o) => !o)} aria-expanded={open}>
        <span>{title}</span>
