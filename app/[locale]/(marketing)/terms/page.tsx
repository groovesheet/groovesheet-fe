...
export async function generateMetadata({ params }: LocaleParams) {
  ...
  return staticRouteMetadata('/terms', locale, {
    description:
      "The terms for using GrooveSheet's AI music transcription and stem separation service: accounts, credits, subscriptions, acceptable use, liability and termination.",
  });
}

export default async function TermsPage(props: LocaleParams) {
          ...
          <div className="legal-body">
            ...
            <div className="legal-section">
              ...
              <p className="legal-text">
                ...
                See our <Link href="/privacy-policy">Privacy Policy</Link> for the specific OAuth scopes used and how Google API data is handled.
              </p>
            </div>
