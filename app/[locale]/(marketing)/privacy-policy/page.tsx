...
export async function generateMetadata({ params }: LocaleParams) {
  ...
  return staticRouteMetadata('/privacy-policy', locale, {
    description:
      'What GrooveSheet collects, how uploaded audio and outputs are processed and retained, who data is shared with, and the choices you have.',
  });
}

export default async function PrivacyPolicyPage(props: LocaleParams) {
