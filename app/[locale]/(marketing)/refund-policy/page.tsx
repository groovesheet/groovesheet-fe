...
export async function generateMetadata({ params }: LocaleParams) {
  ...
  return staticRouteMetadata('/refund-policy', locale, {
    description:
      'How GrooveSheet subscriptions are cancelled, when refunds or credits are given, how monthly credits expire, and what happens when a job fails.',
  });
}

export default async function RefundPolicyPage(props: LocaleParams) {
